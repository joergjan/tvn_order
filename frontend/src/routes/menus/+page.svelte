...
<div class="grid sm:grid-cols-2 sm:space-x-3">
  <ul>
    <h3>Bestellt</h3>
    {#each newOrders as order, i}
      <li>
        <Order {order} showMenuOrDrink="menu" />

        {#if !disabledNewOrders[i]}
          <div class="flex space-x-2">
            {#if order.orderedMenus.status === 1}
              <div class="">
                <form
                ...
                >
                  ...
                  />
                  <button
                    class="group py-2 px-3 rounded-md bg-blue-500 text-white hover:bg-blue-600"
                    type="submit"
                  >
            ...
            {:else if order.orderedMenus.status === 2}
              <div class="">
                <form
  ...
  <ul>
    ...
    {#each ready as order, i}
      <li>
        <Order {order} showMenuOrDrink="menu" />

        {#if !disabledReadyOrders[i]}
          <div class="flex space-x-2">
            {#if order.orderedMenus.status === 1}
              <div class="">
                <form
