<script lang="ts">
  ...
  $: ({ rows, users, username, isAdmin } = data);
...
>
  <div class="flex space-x-5">
    <div class="w-32">
      <div>
        <label for="rowid" class="">Reihe</label>
      </div>
        ...
        <div class="flex justify-center items-center">
          ...
          >
            <svg
              ...
              width="24px"
              class="transition-all duration-200 {rowIndex == 0
                ? 'fill-gray-300'
                : 'fill-red-500'}"
            >
              <path
    ...
    <div class="w-32">
      <div>
        <label for="rowid" class="">Tisch</label>
      </div>
      {#if selectedRowId}
        <div class="flex space-x-2">
          <select
...
<div class="grid md:grid-cols-2 gap-3">
  {#if orders?.length >= 1 && rows?.length >= 1}
    <div>
      <br />
